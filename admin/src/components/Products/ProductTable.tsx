...
const ProductTable: FC<Props> = ({ 
    ...
    const dataGridStyle = {
      ...
      const columns: GridColDef[] = [
        ...
        { field:'imageUrls', headerName:'Image', width: 100, renderCell: 
          (params) => (
            <Box component={'img'} src={params.row.imageUrls[0]} sx={{width:50, height:50}}/>
          )},
        ...
        { field:'action', headerName:'Action', width: 100, renderCell:
          ...
          <Box>
            <IconButton 
              onClick={() => openFormHandler(params.row.id)}
            >
              <Edit/>
            </IconButton>
